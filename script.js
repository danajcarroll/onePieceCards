...
for (let i = 0; i < charCircle.length; i++) {
    charCircle[i].addEventListener('click', function() {
        ...
        // Image Source Change
        preSkipImage.src = `https://danacarroll.com/onePieceCards/images/mainImages/${circleID}-pre.png`;
        postSkipImage.src = `https://danacarroll.com/onePieceCards/images/mainImages/${circleID}-post.png`;
